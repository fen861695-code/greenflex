...
| `v0.1.0-user-mvp` | pending | Security-audited user release | pending final tag | all v1 fixtures | `scripts/dev.ps1` | pending Gitleaks, real Ollama smoke, and GitHub checks | `git switch --detach v0.1.0-user-mvp` |
